...
class FilamentFailedJobsPlugin implements Plugin
{
    ...
    {
        return $this->resource ?? config('filament-failed-jobs.resources.resource');
    }
    ...
    {
        return $this->evaluate($this->label) ?? config('filament-failed-jobs.resources.label');
    }
    ...
    {
        return $this->evaluate($this->pluralLabel) ?? config('filament-failed-jobs.resources.plural_label');
    }
    ...
    {
        return $this->navigationGroup ?? config('filament-failed-jobs.resources.navigation_group');
    }
    ...
    {
        return $this->navigationIcon ?? config('filament-failed-jobs.resources.navigation_icon');
    }
    ...
    {
        return $this->navigationSort ?? config('filament-failed-jobs.resources.navigation_sort');
    }
    ...
    {
        return $this->navigationCountBadge ?? config('filament-failed-jobs.resources.navigation_count_badge');
    }
    ...
    {
        return $this->navigation ?? config('filament-failed-jobs.resources.enabled');
    }
