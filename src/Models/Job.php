...
namespace Amvisor\FilamentFailedJobs\Models;
...
class Job extends Model
{
    ...
    {
        if (FilamentJobsPlugin::get()->getPruning()) {
            return static::where('created_at', '<=', now()->subDays(FilamentJobsPlugin::get()->getPruningRetention()));
        }
